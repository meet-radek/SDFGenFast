...
// Test harness for validating SDF file I/O using OBJ files
...
int main(int argc, char* argv[]) {
    std::cout << "========================================\n";
    std::cout << "SDFGen OBJ File I/O Test\n";
    std::cout << "========================================\n\n";

    // OBJ file path (relative to tests directory - WORKING_DIRECTORY in CMakeLists.txt)
    ...
    // File paths
    const char* cpu_filename = "test_obj_cpu.sdf";
    const char* gpu_filename = "test_obj_gpu.sdf";
    ...
    // Print results
    test_utils::print_test_summary("OBJ FILE I/O TEST", result);
